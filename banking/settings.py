...
STATIC_DIR_BANKING=os.path.join(os.path.join(BASE_DIR,'banking'),'static')
...
SECRET_KEY = 'znmdfll(@$tg)bxr239!d_96777#jao*z9i-da#nm=rk98pa^!'
...
STATIC_URL = '/static/'
STATICFILES_DIRS=[
    STATIC_DIR_APP,STATIC_DIR_BANKING,
]
